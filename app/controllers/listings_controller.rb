class ListingsController < ApplicationController
  ...
  before_action :access_deny, only: [:basics, :description, :price, :photos, :calendar, :bankaccount, :publish]
  def index
  ...
  private
  def listing_params
    params.require(:listing).permit(:home_type, :pet_type, :breeding_years, :pet_size, :price_pernight, :listing_title, :listing_content, :active, :address)
  end
